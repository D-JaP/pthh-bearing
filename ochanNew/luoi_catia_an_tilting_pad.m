...
%%
p(1,luoi(1:3,1))=[0.0089 0.0067 0.00095993];
p(2,luoi(1,1:3))=[1.670405 1.673951 1.683049 ];

p(1,luoi(31:-1:29,1))=[0.010035643198967 0.008726646259972 0.00099483767];
p(2,luoi(31,1:4))=[1.127208 1.125266 1.115386 1.110876];

p(1,luoi(1:3,31))=[0.340129764628655 0.342328879486168 0.348105919310269];
p(2,luoi(1,31:-1:29))=[1.670405 1.673951 1.683505];

p(1,luoi(31:-1:29,31))=[0.339030207199898 0.340339204138894 0.348071012725229];
p(2,luoi(31,31:-1:28))=[1.127208 1.125266 1.115386 1.110876];
...
plot((0:kchia_n)*beta/kchia_n/pi*180,mtp(kchia_m/2+1,1:kchia_n+1),'-^',(0:kchia_n)*beta/kchia_n/pi*180,mtp(kchia_m*0.8+1,1:kchia_n+1),'-s',(0:kchia_n)*beta/kchia_n/pi*180,mtp(kchia_m*0.2+1,1:kchia_n+1),'-o')
...
[x,y,z]=pol2cart(theta,r,mtp);
% pp(:,:)=pp(1,luoi(:,:));
surf(x,y,z)

% contour3(x,y,z/1e6,5,'ShowText','on')
